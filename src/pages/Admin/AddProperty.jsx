...
export default function PropertyIntakeForm() {
  ...
  const validateForm = () => {
    ...
    } else if (!isStrictInteger(String(formData.pricePerSqft))) {
      newErrors.pricePerSqft = "Only numbers allowed.";
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Failed to add property. Please check your inputs.",
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <Select
                  ...
                  onChange={handleChange}
                  options={["Apartment", "Villa", "Plot", "Commercial", "Office", "Shop"]}
                />
              ...
              <div>
                ...
                <Select
                  ...
                  onChange={handleChange}
                  options={["Draft", "Active", "Inactive", "Sold"]}
                />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
