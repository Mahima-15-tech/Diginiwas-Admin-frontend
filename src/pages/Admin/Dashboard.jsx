...
// import { MdOutlineGridView, MdOutlineApartment, MdOutlineWeb, MdOutlineFlashOn, MdOutlineShield, MdOutlineLocationOn, MdOutlineTrendingUp, MdOutlineVerifiedUser, MdOutlinePersonAdd, MdOutlineDescription } from "react-icons/md";
// import { BsArrowUpShort, BsArrowDownShort, BsBarChartFill } from "react-icons/bs";
// import { useNavigate } from "react-router-dom";
// import PropertyManagement from "../Admin/Property/PropertyManagement";
// import CMSDashboard from "./CMS/CMSDashboard";
// import PropertyApproval from "./Property/PropertyApproval";
// // import Buyers from "./Buyers";
// import Leads from "./Leads/Leads";
// import Sellers from "../Admin/Seller/SellersManagement";
// import WalletCreditDashboard from "./Credits/WalletCredits";
// import UsersManagement from "./UsersManagement";
// import PropertyCommandCenter from "./Property/PropertyCommandCenter";
// import PropertyVerificationCenter from "./Property/PropertyVerification";
// import PropertyAuditHistory from "./Property/PropertyHistory";
// import LeadManagementApp from "./Leads/LeadManagemnet";
// import PartnerAssignmentQueue from "./Partner/PartnerAssigned";
// import VisitManagement from "./Partner/VisitManagement"
...
// import SellerDashboard from "./Seller/SellerDahboard"
...
// const navItems = [
//   { icon: <MdOutlineGridView size={20} />, label: "Dashboard" },
//   { icon: <MdOutlineApartment size={20} />, label: "Property Management" },
//   { icon: <MdOutlineWeb size={20} />, label: "CMS" },
//  { icon: <MdOutlineWeb size={20} />, label: "Buyer Dashboard" },
//  { icon: <MdOutlineWeb size={20} />, label: "Partner Dashboard" },
//   { icon: <MdOutlineWeb size={20} />, label: "Seller Dashboard" },
//   { icon: <MdOutlineWeb size={20} />, label: "Leads Dashboard" },
//    { icon: <MdOutlineWeb size={20} />, label: "Property" },
//   // { icon: <MdOutlinePersonAdd size={20} />, label: "Buyers" },
//   // { icon: <MdOutlineShield size={20} />, label: "Partner" },
//   // { icon: <MdOutlineFlashOn size={20} />, label: "Sellers" },
//    { icon: <MdOutlineShield size={20} />, label: "Users" },
//   // { icon: <MdOutlineDescription size={20} />, label: "Leads" },
//   //  { icon: <MdOutlineWeb size={20} />, label: "Property Approval" },
//   { icon: <MdOutlineShield size={20} />, label: "Wallet Credits" },
 
//   // { icon: <MdOutlineShield size={20} />, label: "Property Command Center" },
//   // { icon: <MdOutlineShield size={20} />, label: "Property Verificaton Center" },
//   // { icon: <MdOutlineShield size={20} />, label: "Property History" },
//   // { icon: <MdOutlineShield size={20} />, label: "Lead Management" },
//   // { icon: <MdOutlineShield size={20} />, label: "Partner Assigment" },
//   // { icon: <MdOutlineShield size={20} />, label: "Visit Management" },
//   // { icon: <MdOutlineShield size={20} />, label: "Partner Application" },
...
//           <aside className="relative w-64 bg-white h-full flex flex-col py-6 px-5 shadow-xl z-10 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
//             <div className="flex items-center justify-between mb-8">
//               <div className="mb-6 w-full flex items-center justify-start p-1.5 rounded-xl bg-transparent">
//                 <img
//                   src={Logo}
//                   alt="DigiNiwas Logo"
//                   className="h-16 w-full object-contain object-left drop-shadow-[0_2px_8px_rgba(13,45,42,0.15)]"
//                   onError={(e) => {
//                     e.target.style.display = 'none';
//                     e.target.nextSibling.style.display = 'block';
//                   }}
//                 />
//                 <span className="hidden text-xl font-black tracking-wider text-teal-900 px-2">DIGINIWAS</span>
//               </div>
...
//                     className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors text-left ${isActive ? "text-teal-700 font-semibold bg-teal-50 border-r-4 border-teal-600" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
//                   >
...
//       {/* Desktop Sidebar */}
//       {/* Added overflow-y-auto and scrollbar-hiding utilities */}
//       <aside className="hidden lg:flex flex-col w-60 flex-shrink-0 bg-white sticky top-0 h-screen py-6 px-5 border-r border-gray-100 justify-between overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        
//         {/* Top Section: Logo + Navigation Links */}
//         <div className="flex flex-col flex-1">
//           {/* Logo Container */}
//           <div className="mb-6 w-full flex items-center justify-start p-1 rounded-xl bg-transparent">
//             <img
//               src={Logo}
//               alt="DigiNiwas Logo"
...
//               navigate("/"); 
//             }}
//             className="w-full flex items-center gap-3 py-2.5 px-3 rounded-xl text-sm font-medium text-red-600 hover:bg-red-50 hover:text-red-700 transition-all duration-200 text-left group"
//           >
//             <svg 
...
//           {activeTab === "Partner Dashboard" && (<PartnerDashboard />)}
// {activeTab === "Seller Dashboard" && (<SellerDashboard />)}
// {activeTab === "Leads Dashboard" && (<LeadDashboard />)}
          
//           {activeTab === "Property" && (<PropertyDashboard />)}
//           {activeTab === "Property Approval" && (<PropertyApproval />)}
//           {activeTab === "Buyers" && (<Buyers />)}
//           {activeTab === "Leads" && (<Leads />)}
//           {activeTab === "Sellers" && (<Sellers />)}
//           {activeTab === "Wallet Credits" && (<WalletCreditDashboard />)}
//           {activeTab === "Users" && (<UsersManagement />)}
//           {activeTab === "Property Command Center" && (<PropertyCommandCenter />)}
//           {activeTab === "Property Verificaton Center" && (<PropertyVerificationCenter />)}
//           {activeTab === "Property History" && (<PropertyAuditHistory />)}
//           {activeTab === "Lead Management" && (<LeadManagementApp />)}
//           {activeTab === "Partner Assigment" && (<PartnerAssignmentQueue />)}
//           {activeTab === "Visit Management" && (<VisitManagement />)}
//           {activeTab === "Partner" && (<PartnerManagement />)}
//           {activeTab === "Partner Application" && (<PartnerApplications />)}
//         </main>
//       </div>
//     </div>
//   );
