...
// import { MdOutlineGridView, MdOutlineApartment, MdOutlinePeople,MdOutlineWeb, MdOutlineContactPhone, MdOutlineLightbulb, MdOutlineBarChart, MdOutlineSettings, MdOutlinePersonAdd, MdOutlineDescription, MdOutlineFlashOn, MdOutlineShield, MdOutlineLocationOn, MdOutlineTrendingUp, MdOutlineVerifiedUser } from "react-icons/md";
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <aside className="relative w-64 bg-white h-full flex flex-col py-6 px-5 shadow-xl z-10">
            <div className="flex items-center justify-between mb-8">
              ...
              {/* 2. Mobile Logo Container */}
              {/* <div className="h-20 w-auto flex items-center p-1 rounded-lg bg-slate-100">
                <img
                  src={Logo}
                  alt="DigiNiwas Logo"
                ...
                />
                <span className="hidden text-lg font-black tracking-wider text-teal-900 px-2">DIGINIWAS</span>
              </div> */}
...
<div className="mb-6 w-full flex items-center justify-start p-1.5 rounded-xl bg-transparent">
  <img
    src={Logo}
    alt="DigiNiwas Logo"
    // h-16 se height sahi badhegi aur w-full + object-left se left margin balance hoga
  ...
  <span className="hidden text-xl font-black tracking-wider text-teal-900 px-2">DIGINIWAS</span>
      ...
      {/* <aside className="hidden lg:flex flex-col w-60 flex-shrink-0 bg-white sticky top-0 h-screen py-6 px-5 border-r border-gray-100">
        ...
        <div className="mb-8 h-14 w-auto flex items-center p-1 rounded-xl bg-slate-50 border border-gray-100 shadow-sm">
          <img
            src={Logo}
            alt="DigiNiwas Logo"
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                key={item.label}
                onClick={() => setActiveTab(item.label)}
                className={`w-full flex items-center gap-3 py-2.5 rounded-xl text-sm transition-all duration-200 text-left ${isActive ? "text-teal-700 font-semibold border-r-4 whitespace-nowrap border-teal-600 bg-teal-50" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
              >
                <span className={isActive ? "text-teal-600" : "text-gray-400"}>
                  {item.icon}
                </span>
...
{/* Desktop Sidebar */}
{/* Desktop Sidebar */}
<aside className="hidden lg:flex flex-col w-60 flex-shrink-0 bg-white sticky top-0 h-screen py-6 px-5 border-r border-gray-100 justify-between">
  ...
  <div className="pt-4 border-t border-gray-100">
    <button
      onClick={() => {
        // Yahan apna logout logic daalein, jaise token clear karna ya redirect karna
    ...
    >
      {/* Logout Icon (FiLogOut import karna hoga react-icons/fi se) */}
      <svg 
